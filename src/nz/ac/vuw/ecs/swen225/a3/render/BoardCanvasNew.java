...
//        view = adjustView(viewWindow);
     ...
     */
    private GenericTile[][] adjustView(int viewWindow) {

        GenericTile[][] view = new GenericTile[viewWindow][viewWindow]; //the new view of the player, this will leave out some
